...
def main():
    ...
    # print(key)
    print("this is the guessed secret message, you need to guess the missing letters to finnish the message: \n" )
    print(decryptCipherWithKey(secret_cipher, key))
    print("\n\nNOTE: the '_' character can be the placeholder for a alphanumeric character or a space!! and the key may not be 100% accurate")
